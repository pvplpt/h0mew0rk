...
1. Программы запускаются и работают корректно, нет синтаксических ошибок.
2. Имена переменных корректны, отражают суть хранимых данных.
3. Создан текстовый интерфейс для всех программ.
4. Для всех заданий обеспечен контроль ввода, который обусловлен логикой работы программы. Не должно быть 1. обращения к элементам за границы строки.
5. Выполнено два задания и более.
